...
const FILLED = {
  ...
  gradient:
    'w-full text-high-emphesis bg-gradient-to-r from-pink to-opaque-pink opacity-80 hover:opacity-100 disabled:bg-opacity-80',
}
...
const OUTLINED = {
  ...
  gradient:
    'border border-transparent border-gradient-r-yellow-orange-dark-900 opacity-80 hover:opacity-100 disabled:bg-opacity-20',
}
