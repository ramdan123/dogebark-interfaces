        ...
        <Dialog as="div" onClose={onDismiss} className="fixed inset-0 z-10 overflow-y-hidden backdrop-blur-md">
          ...
          <div className="flex items-center justify-center h-screen px-4">
            ...
            >
              ...
              >
                <div className="w-full p-px rounded bg-gradient-to-r from-[#11998E] to-[#38EF7D]">
                  <div className="flex flex-col w-full h-full p-6 overflow-x-auto overflow-y-auto rounded bg-dark-900">
