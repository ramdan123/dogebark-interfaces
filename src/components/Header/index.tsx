            ...
            <div className="px-4 py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <Image src="/logo.png" alt="DOGEBARK" width="42" height="42px" />
                ...
                <div className="fixed bottom-0 left-0 z-10 flex flex-row items-center justify-center w-full p-4 lg:w-auto bg-dark-1000 lg:relative lg:p-0 lg:bg-transparent">
                  <div className="flex items-center justify-between w-full space-x-2 sm:justify-end">
                    {chainId && chainId in MIST_ADDRESS && library && library.provider.isMetaMask && (
                      <>
                        <AddToken
                          imageProps={{ src: '/images/tokens/dogebark-square.jpg', alt: 'DOGEBARK' }}
                          text={i18n._(t`Add DOGEBARK to your MetaMask wallet`)}
                          metamaskProps={{
                            address: '0x7A20Be722D064FEE9e756dC9C281c9413F36700b',
                            symbol: 'DOGEBARK',
                            decimals: 18,
                            image: 'https://assets.dogebark.dog/logo.png',
                          }}
                        />
                      </>
                    )}
