...
export const XMIST: ChainTokenMap = {
  [ChainId.DOGECHAIN]: new Token(ChainId.DOGECHAIN, BAR_ADDRESS[ChainId.DOGECHAIN], 18, 'DOGEBARK', 'Doge Bark'),
}
...
export const MIST: ChainTokenMap = {
  [ChainId.DOGECHAIN]: new Token(ChainId.DOGECHAIN, MIST_ADDRESS[ChainId.DOGECHAIN], 18, 'DOGEBARK', 'Doge Bark'),
}
