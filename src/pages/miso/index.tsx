            ...
            <div className="grid grid-cols-12 gap-4 mb-6 min-h-1/2">
              ...
              <Article
                ...
                content={`MISO is a suite of open-source smart contracts created to ease the process of launching 
                          a new project on the DOGEBARK exchange. MISO aims to drive new capital and trade to the exchange 
                          by increasing the attractiveness of DOGEBARK as a place for token creators and communities to launch 
                          new project tokens.`}
              />
            </div>
          </div>
