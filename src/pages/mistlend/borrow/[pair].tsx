...
import { CurrencyAmount } from '@dogebark/sdk'
...
function Pair() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Borrow ${pair?.asset?.symbol}-${pair?.collateral?.symbol}`)} | DOGEBARK</title>
        <meta
          key="description"
          name="description"
        ...
        <Card className="h-full bg-dark-900">
          <div className="flex-col space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <div className="flex flex-row items-center text-lg text-high-emphesis">
                {i18n._(t`None`)}
                <QuestionHelper
                  text={i18n._(
                        ...
                        {pair.oracle.name.includes('TWAP0')
                          ? formatNumber(
                              CurrencyAmount.fromFractionalAmount(
                                liquidityPair?.reserve0.currency,
                                liquidityPair?.reserve1.numerator,
                                liquidityPair?.reserve1.denominator
                              )
