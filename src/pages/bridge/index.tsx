...
export default function Bridge() {
  ...
  return (
    <>
      ...
      <Head>
        <title>{i18n._(t`Bridge`)} | DOGEBARK</title>
          ...
          <div className="p-4 space-y-4 rounded bg-dark-900" style={{ zIndex: 1 }}>
            ...
            {helpVisible && (
              <div className="p-3 mx-5 rounded bg-dark-800">
                <p>
                  {i18n._(
                    t`This service helps you to try out the DogeChain network by converting your assets to Doge and bridging it to our network`
                  )}
                </p>
                <p>{i18n._(t`Our bridge utilizes a two-step process:`)}</p>
                <p className="pl-4">
                  {i18n._(t`1) asset coversion from anything to Doge with`)}{' '}
                ...
                <p className="pl-4">
                  {i18n._(t`2) bridging the Doge to DogeChain with `)}{' '}
                ...
                <p>
                  {i18n._(
                    t`For issues related to hop cash, note the Doge and DogeChain transaction ids and ask for support here:`
                  )}{' '}
