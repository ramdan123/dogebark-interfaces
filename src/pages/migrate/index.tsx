...
import { ChainId, Token, CurrencyAmount, JSBI } from '@dogebark/sdk'
  ...
  /*
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="text-xs text-center text-low-emphesis">
...
export default function MigrateV2() {
  ...
  return (
    <Container id="migrate-page" className="py-4 space-y-6 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
          <title key="title">Migrate LP tokens | DOGEBARK</title>
          <meta
            key="description"
            name="description"
