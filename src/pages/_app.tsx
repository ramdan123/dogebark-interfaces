  ...
  return (
    <Fragment>
      <Head>
        ...
        />
        <title key="title">DOGEBARK</title>
        ...
        <meta name="application-name" content="DOGEBARK App" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
        <meta name="apple-mobile-web-app-title" content="DOGEBARK App" />
        ...
        <meta key="twitter:title" name="twitter:title" content="DOGEBARK App" />
        <meta key="twitter:url" name="twitter:url" content="https://app.dogebark.dog" />
        <meta
          key="twitter:description"
          name="twitter:description"
          content="Trade, launch, stake, farm, invest, automate, build on the premier DeFi platform of DogeChain"
        />
        <meta key="twitter:image" name="twitter:image" content="https://app.dogebark.dog/icons/icon-192x192.png" />
        <meta key="twitter:creator" name="twitter:creator" content="@dogebarkswap" />
        <meta key="og:type" property="og:type" content="website" />
        <meta key="og:site_name" property="og:site_name" content="dogebark App" />
        <meta key="og:url" property="og:url" content="https://app.dogebark.dog" />
        <meta key="og:image" property="og:image" content="https://app.dogebark.dog/apple-touch-icon.png" />
        <meta
          key="og:description"
