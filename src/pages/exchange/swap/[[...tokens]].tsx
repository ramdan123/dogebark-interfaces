import { ChainId, Currency, CurrencyAmount, JSBI, Token, TradeType, Trade as V2Trade } from '@dogmoneyswap/sdk'
...
export default function Swap() {
  ...
  return (
    <Container id="swap-page" className="py-4 md:py-8 lg:py-12">
      <Head>
        <title>DOGEBARK | DOGEBARK</title>
        <meta key="description" name="description" content="DOGEBARK allows for swapping of ERC-20 compatible tokens" />
      </Head>
      <TokenWarningModal
