...
import { Currency, CurrencyAmount, Percent, WNATIVE, currencyEquals } from '@dogebark/sdk'
...
export default function Add() {
  ...
  return (
    <>
      <Head>
        <title>Add Liquidity | DOGEBARK</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the DOGEBARK AMM to enable gas optimised and low slippage trades"
        />
      </Head>
      ...
      <Container id="add-liquidity-page" className="py-4 space-y-6 md:py-8 lg:py-12" maxWidth="2xl">
        <div className="flex items-center justify-between px-4 mb-5">
          <NavLink href="/pool">
            <a
              className="flex items-center space-x-2 text-base font-medium text-center cursor-pointer text-secondary"
              style={{ background: 'aliceblue', padding: '0.5rem' }}
            >
