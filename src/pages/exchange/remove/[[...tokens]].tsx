...
import { ChainId, Currency, NATIVE, Percent, WNATIVE, WNATIVE_ADDRESS } from '@dogebark/sdk'
  ...
  */
  ...
  return (
    <Container id="remove-liquidity-page" className="py-4 space-y-4 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Remove Liquidity | DOGEBARK</title>
        <meta key="description" name="description" content="Remove liquidity from the DOGEBARK AMM" />
      </Head>
