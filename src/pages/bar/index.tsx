...
export default function Stake() {
  ...
  return (
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        <title key="title">Stake | DOGEBARK</title>
        <meta
          key="description"
          name="description"
          content="Stake DOGEBARK in return for DOGEBARK, an interest bearing and fungible ERC-20 token designed to share revenue generated by all DOGEBARK products."
        />
        <meta key="twitter:url" name="twitter:url" content="https://app.sogebark.dog/stake" />
        <meta key="twitter:title" name="twitter:title" content="STAKE DOGEBARK" />
        <meta
          key="twitter:description"
          name="twitter:description"
          content="Stake DOGEBARK in return for DOGEBARK, an interest bearing and fungible ERC-20 token designed to share revenue generated by all DOGEBARK products."
        />
        <meta key="twitter:image" name="twitter:image" content="https://app.dogebark.dog/xmist-sign.png" />
        <meta key="og:title" property="og:title" content="STAKE DOGEBARK" />
        <meta key="og:url" property="og:url" content="https://app.dogebark.dog/stake" />
        <meta key="og:image" property="og:image" content="https://app.DOGEBARK.money/xmist-sign.png" />
        <meta
          key="og:description"
          property="og:description"
          content="Stake DOGEBARK in return for xDOGEBARK, an interest bearing and fungible ERC-20 token designed to share revenue generated by all DOGEBARK products."
        />
      </Head>
          ...
          <div className="flex flex-col w-full max-w-xl mt-auto mb-2">
            <div className="flex max-w-lg">
              <div className="self-end mb-3 text-lg font-bold md:text-2xl text-high-emphesis md:mb-7">
                {i18n._(t`Maximize yield by staking DOGEBARK for xDOGEBARK`)}
              </div>
            ...
            <div
              ...
              style={{ background: '#3c3cff', color: '#ffffff', lineHeight: '2rem' }}
            >
              {i18n._(t`For every swap on the exchange on every chain, 0.05% of the swap fees are distributed as DOGEBARK
                                proportional to your share of the DOGEBARKBowl. When your DOGEBARK is staked into the DOGEBARKBowl, you receive
                                xDOGEBARK in return.
                                Your xDOGEBARK is continuously compounding, when you unstake you will receive all the originally deposited
                                DOGEBARK and any additional from fees.`)}
            </div>
            {/* <div className="flex">
              ...
              <div className="w-full max-w-xl px-3 pt-2 pb-6 rounded bg-dark-900 md:pb-9 md:pt-4 md:px-8">
                ...
                <div className="flex items-center justify-between w-full mt-6">
                  <p className="font-bold text-large md:text-2xl text-high-emphesis">
                    {activeTab === 0 ? i18n._(t`Stake DOGEBARK`) : i18n._(t`Unstake`)}
                  </p>
                  ...
                  <div className="border-gradient-r-pink-red-light-brown-dark-pink-red border-transparent border-solid border rounded-3xl px-4 md:px-3.5 py-1.5 md:py-0.5 text-high-emphesis text-xs font-medium md:text-base md:font-normal">
                    {`1 xDOGEBARK = ${xSushiPerSushi.toFixed(4)} DOGEBARK`}
                  </div>
                </div>
                ...
                <div className="relative w-full h-0 pointer-events-none bottom-14">
                  ...
                  >
                    <div className="flex space-x-2 ">
                      ...
                      >
                        {`${input ? input : '0'} ${activeTab === 0 ? '' : 'x'}DOGEBARK`}
                      </p>
                    </div>
                ...
                <div className="flex flex-col flex-grow md:mb-14">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">xDOGEBARK</p>
                    </div>
                  </div>
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <div className="flex items-center ml-8 space-x-4 md:ml-0">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">DOGEBARK</p>
                    </div>
                  </div>
                </div>
